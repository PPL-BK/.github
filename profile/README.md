# 📘 Khóa Học PPL1 - HK251 (Bắt đầu: 03/01)

## 🎯 Mục tiêu khóa học
- Hiện thực **BTL1** và **BTL2**
- Ôn tập **Harmony BTL1 & BTL2** để làm bài **trên lớp**  
  > (Kỳ này khả năng **không còn Harmony GK**, thay vào đó là làm trực tiếp trên lớp)
- Viết **biểu thức chính quy** cho **Lexer + Parser**
- Nắm kiến thức **Python 3**
- Ôn tập **DSA – Tree** cho AST
...
## 📚 Cách học **Discord** là nơi chính để học tập
- `ID-chat-Tên`: Kênh riêng để **hỏi bài, trao đổi 24/7**
- `ID-bot-Tên`: Kênh riêng chấm **testcase**
